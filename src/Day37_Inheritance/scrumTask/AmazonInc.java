...
public class AmazonInc {
    public static void main(String[] args) {
        ...
        ProductOwner po=new ProductOwner("Suahib",29,'M',1,160000,companyName);
        BusinessAnalyst ba=new BusinessAnalyst("Cihad",30,'M',2,155000,companyName);
        ScrumMaster sm=new ScrumMaster("Anel",26,'F',3,140000,companyName);
