...
public class UnaryOperators {
    public static void main(String[] args) {
        ...
        int a=5;
        ++a;  //pre increment: increases value the by 1 right away

        System.out.println(a); //6

        --a;  //pre decrement: decreases value the by 1 right away
        ...
        int b=100;
        System.out.println(++b);//pre increment: increases value the by 1 right away
